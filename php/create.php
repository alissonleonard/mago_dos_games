...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
if (empty($vendedor) || empty($fabricante)  || empty($modelo)  || empty($preco)  || empty($email)  || empty($telefone)) {
    $errorMessage = "Todos os campos são obrigatórios";
    break;
}

//adicionar um novo produto no database

$sql = "INSERT INTO consoles (vendedor, fabricante, modelo, preco, email, telefone) " . "VALUES('$vendedor', '$fabricante', '$modelo', '$preco', '$email', '$telefone')";
...
$sucessMessage = "Produto Cadastrado com sucesso";
